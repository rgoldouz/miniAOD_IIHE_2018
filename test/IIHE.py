...
process.finalGenParticles = prunedGenParticles.clone()
process.finalGenParticles.src = cms.InputTag("prunedGenParticles")
...
process.IIHEAnalysis.genParticleSrc                        = cms.InputTag("finalGenParticles")
#
